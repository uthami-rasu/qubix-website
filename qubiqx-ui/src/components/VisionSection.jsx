  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 space-y-8">
        ...
        {/* CTA Button */}
        <div className="pt-8">
          <button className="px-10 py-4 bg-gradient-to-r from-[#ef4444] to-[#c2410c] text-white font-bold text-lg rounded-full shadow-[0_10px_30px_rgba(239,68,68,0.3)] hover:shadow-[0_15px_40px_rgba(239,68,68,0.5)] transition-all duration-300 hover:-translate-y-1 active:scale-95">
            Start Your Project
          </button>
        </div>
      </div>
