  ...
  return (
    <section className="relative min-h-screen bg-black flex flex-col items-center justify-center text-center px-4 pt-24 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center gap-8">
        ...
        {/* Subtext */}
        <p className="text-gray-400 text-base md:text-lg max-w-2xl leading-relaxed font-sans">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 mt-6 w-full sm:w-auto">
          <button className="w-full sm:w-auto bg-gradient-to-r from-red-600 to-red-400 text-white px-10 py-4 rounded-full font-semibold flex items-center justify-center gap-2 shadow-[0_0_25px_rgba(220,38,38,0.3)] hover:shadow-[0_0_40px_rgba(220,38,38,0.5)] transition-all duration-300 active:scale-95 group">
            Start Your Project
          ...
          <button className="w-full sm:w-auto bg-white/5 backdrop-blur-lg border border-white/10 text-white px-10 py-4 rounded-full font-semibold flex items-center justify-center gap-3 hover:bg-white/10 hover:border-white/20 transition-all duration-300 active:scale-95 group text-sm md:text-base">
            View Our Work
